...
<html>
    ...
    <body>
        ...
        <section class="carros">
            <div id="izq">
            <h3><a class="marca" href="spin.php">Toyota Corolla</a></h3>
            ...
            <div id="cen">
            <h3><a class="marca" href="s10.php">Chevrolet Astra</a></h3>
            <img src="https://www.auto-magic.com.mx/wp-content/uploads/2016/12/BISELES-ASTRA.jpg" width="200"/>
            </div>
            
            <div id="der">
            <h3><a class="marca" href="malibu.php">Nissan</a></h3>
