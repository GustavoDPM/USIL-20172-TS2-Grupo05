...
<html>
    ...
    <body>
        ...
        <section class="carros">
            <div id="izq">
            <h3><a class="marca" href="spin.php">Mercedes-Benz SLS AMG</a></h3>
            ...
            <div id="cen">
            <h3><a class="marca" href="s10.php">Renault Fluence </a></h3>
            ...
            <div id="der">
            <h3><a class="marca" href="malibu.php">Land Rover LR4</a></h3>
        ...
        <section class="carros">
            <div id="izq">
            <h3><a class="marca" href="trail.php">Ford Mustang GT</a></h3>
            ...
            <div id="cen">
            <h3><a class="marca" href="suburban.php">Buick LaCrosse CXS</a></h3>
            ...
            <div id="der">
            <h3><a class="marca" href="tracker.php">Hyundai Genesis</a></h3>
